...
class AudioService extends ChangeNotifier {
  ...
  Future<void> playLetterName(String letter) async {
    await _playNarration('assets/audio/letters/${letter.toLowerCase()}.mp3');
  }

  /// Play phonics sound (e.g., "/æ/" for A).
  Future<void> playPhonicsSound(String letter) async {
    await _playNarration('assets/audio/phonics/${letter.toLowerCase()}.mp3');
  }

  /// Play word pronunciation (e.g., "Apple").
  Future<void> playWordPronunciation(String wordId) async {
    await _playNarration('assets/audio/words/$wordId.mp3');
  }
  ...
  Future<void> playMascotDialogue(String dialogueId) async {
    await _playNarration('assets/audio/mascot/$dialogueId.mp3');
  }
  ...
  Future<void> playSuccess() async {
    await _playSfx('assets/audio/sfx/success.mp3');
  }
  ...
  Future<void> playTryAgain() async {
    await _playSfx('assets/audio/sfx/try_again.mp3');
  }
  ...
  Future<void> playHintSound() async {
    await _playSfx('assets/audio/sfx/hint.mp3');
  }
  ...
  Future<void> playCelebration() async {
    await _playSfx('assets/audio/sfx/celebration.mp3');
  }
  ...
  Future<void> playTap() async {
    await _playSfx('assets/audio/sfx/tap.mp3');
  }
  ...
  void fromSettingsMap(Map<String, dynamic> settings) {
    ...
    _musicVolume = (settings['musicVolume'] as num?)?.toDouble() ?? 0.3;
